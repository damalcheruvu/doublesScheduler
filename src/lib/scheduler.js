...
// MAJOR REDESIGN: Much stronger partnership constraints
const SCORING_CONFIG = {
  SELECTION: {
    REST_COUNT_WEIGHT: 1000,
    GAME_COUNT_WEIGHT: 500,
    CONSECUTIVE_REST_WEIGHT: 800,
    LAST_ROUND_REST_BONUS: 1200,
  },
  // CRITICAL: Make repeated partnerships extremely costly
  PARTNERSHIP_PENALTY: 50000, // Currently unused, kept for tuning if you remove hard blocking
...
export class BadmintonManager {
  constructor(
    ...
    this.weights = weights; // Legacy parameter, kept for backward compatibility but unused
  ...
  _initializePlayerStats() {
    for (const player of this.players) {
      this.playerStats.set(player, {
        ...
        consecutiveGames: 0, // currently not used in logic, but kept for compatibility
