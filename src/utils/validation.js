...
/**
 * Find duplicate player names (case-insensitive)
 * @param {string} playersText - Newline-separated player names
 * @returns {Array<[string, Array<string>]>} Array of [lowercase_name, duplicate_names]
 */
export const findDuplicates = playersText => {
